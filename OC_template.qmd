---
title: "`r params$country` `r params$methodgroup`"
subtitle: "Data slides for the PRH Private Sector Working Group"
...
params: # Set default parameter key-value pairs
  country: Nigeria                   
  methodgroup: Oral Contraceptives 
footer: "The two charts are from different data sources and may represent overlapping/ duplicative data."
---

```{r Purpose, Version and Learning}
# Purpose: Create data slides that tell the story of oral contraceptive trends in a country using multiple data sources, for use by the PRH Private sector working group
# Author: Arati Krishnamoorthy
# Version Control:
...
dkt <- dkt |> 
  mutate(
    ...
    program = case_when(
      program == "AMOS/USAID" 
      ~ "ASMO/USAID",
      program == "SOCPIETY FOR FAMILY HEALTH" 
